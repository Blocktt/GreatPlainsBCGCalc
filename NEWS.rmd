...
* refactor: Modify "BCG_3metmemb_xtab_METRICSORT.csv" for alternate rules, Issue #6
...
* refactor: Update text File Builder, within app for index name and classes for bugs
...
* Removed copies of MetricNames.xlsx, MetricFlags.xlsx, and Rules.xlsx in the output reference folder
