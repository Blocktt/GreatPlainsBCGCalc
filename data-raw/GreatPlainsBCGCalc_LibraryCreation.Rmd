...
path_results <- file.path("inst", "apps", "GreatPlainsBCGCalc", "results")
...
path_shiny <- file.path("inst", "apps", "GreatPlainsBCGCalc")
fn_copy    <- "remove.txt"
